...
## Overview
RAG Evaluator is a evaluating Retrieval-Augmented Generation (RAG) systems. It provides various metrics to evaluate the quality of generated text against reference text.
...
print(metrics)
```
![image](https://github.com/user-attachments/assets/a43cbd96-5f99-4088-8126-187c4613f711)
...
![image](https://github.com/user-attachments/assets/ecbbadea-cf18-49c9-a76a-8692440ee9be)
